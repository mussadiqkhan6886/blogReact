...
const PostPage = ({posts, handleDelete}) => {
  ...
  return (
    ...
    <>
      ...
      <button className='bg-red-600 text-white hover:bg-red-700 mt-4 cursor-pointer px-3 py-1' onClick={() => handleDelete(id)}>Handle Delete</button>
      <button className='bg-red-600 text-white hover:bg-red-700 mt-4 cursor-pointer px-3 py-1'><Link to={"/edit/"+find.id}>Edit Post</Link></button>
    </>}
    {!find && 
    <>
